...
/***/ function(module, exports, __webpack_require__) {
	...
	window.startAnnualReport = function () {

		var container = document.getElementById('wrapper');
		var element = _react2.default.createElement(_layout2.default, { pages: _pages2.default });
	...
	var Layout = (function (_React$Component) {
	  ...
	  */
		...
		function Layout(props) {
			...
			//   after an interval.
			_this._allowMouseWheelInteraction = true;
			return _this;
		}
	  ...
	  */
		...
		_createClass(Layout, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement('div', { className: 'ar__mid-bar' }),
	   ...
	   */
			...
			value: function renderTopButton() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(_icons.Arrow, { rotate: 90 })
				);
			}
	   ...
	   */
			...
			value: function renderBottomButton() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(_icons.Arrow, { rotate: 270 })
				);
			}
	   ...
	   */
			...
			value: function componentDidMount() {
				...
				(0, _jquery2.default)('body').on('mousewheel.layout', function (e) {
					var delta;
					if (_this2.isMouseWheelEnabled()) {
						if (Math.abs(e.deltaY) > 20) {
							delta = e.deltaY < 0 ? 1 : -1;
							_this2.changeActivePage(delta);
							_this2.disableMouseWheelForInterval();
						}
					}
				});
	   ...
	   */
			...
			value: function componentWillUnmount() {
				(0, _jquery2.default)('body').off('mousewheel.layout');
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Header(props) {
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(_icons.Naf, null),
			_react2.default.createElement(
				'h1',
				null,
				'New America'
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Arrow(props) {
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				'g',
				{ transform: 'rotate(' + (props.rotate - 90) + ' 50 50)' },
				_react2.default.createElement('polygon', { points: '45.9,98.8 45.9,16.2 33.3,29.3 27.4,23.7 47.1,3.3 50,0.4 52.9,3.3 72.6,23.7 66.7,29.3 54.1,16.2 54.1,98.8 ' })
			)
		);
	}
	...
	function Heart(props) {
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				'g',
				null,
				_react2.default.createElement('path', { d: 'M269.1,384.1c-2.1-2.5-7.4-7.3-11.8-10.8c-12.9-10.2-14.7-11.6-19.9-16.7 c-9.7-9.3-13.8-18.6-13.8-31.2c0-6.2,0.4-8.5,2.1-12.2c2.8-6.2,7-10.8,12.2-13.6c3.7-2,5.6-2.9,11.9-2.9c6.5,0,7.9,0.8,11.8,3 c4.7,2.7,9.5,8.4,10.5,12.5l0.6,2.5l1.5-3.5c8.6-19.6,36-19.3,45.5,0.5c3,6.3,3.4,19.7,0.7,27.3c-3.5,9.9-10.1,17.4-25.3,28.9 c-10,7.6-21.3,19-22,20.6C272.3,390.4,273.1,388.8,269.1,384.1z' })
			)
		);
	}
	...
	var Pages = (function (_React$Component) {
	  ...
	  */
		...
		function Pages(props) {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Pages).call(this, props));

			_this.state = { pageWidth: 0 };
			return _this;
		}
	  ...
	  */
	   ...
	   */
			...
			value: function componentDidMount() {
				...
				(0, _jquery2.default)(window).on('resize.pages', function () {
					_this3.forceUpdate();
				});
			}
	   ...
	   */
			...
			key: 'componentWillUnmount',
			value: function componentWillUnmount() {
				(0, _jquery2.default)(window).off('resize.pages');
			}
		}]);
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement('div', { className: 'split__right-circle' })
						)
					),
					_react2.default.createElement(
						'div',
						...
						_react2.default.createElement(
							'div',
							null,
							_react2.default.createElement('p', { dangerouslySetInnerHTML: { __html: page.content } })
						)
					)
				)
			)
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	(function () {
		...
		} else if ("function" === 'function' && _typeof(__webpack_require__(168)) === 'object' && __webpack_require__(168)) {
	...
	function Footer(props) {
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				...
				_react2.default.createElement(_icons.Page, null)
			),
			_react2.default.createElement(
				'a',
				{ className: 'ar__footer__icon-link', href: 'https://www.newamerica.org/contribute/' },
				_react2.default.createElement(_icons.Heart, null)
			)
		);
	}
